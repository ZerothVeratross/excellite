...
#define FLAG_TEMP_5      (TEMP_FLAGS_START + 0x5)  // Formerly unused flag. Can be used for HM objects like trees, boulders and rocks
#define FLAG_TEMP_6      (TEMP_FLAGS_START + 0x6)  // Formerly unused flag. Can be used for HM objects like trees, boulders and rocks
#define FLAG_TEMP_7      (TEMP_FLAGS_START + 0x7)  // Formerly unused flag. Can be used for HM objects like trees, boulders and rocks
#define FLAG_TEMP_8      (TEMP_FLAGS_START + 0x8)  // Formerly unused flag. Can be used for HM objects like trees, boulders and rocks
#define FLAG_TEMP_9      (TEMP_FLAGS_START + 0x9)  // Formerly unused flag. Can be used for HM objects like trees, boulders and rocks
#define FLAG_TEMP_A      (TEMP_FLAGS_START + 0xA)  // Formerly unused flag. Can be used for HM objects like trees, boulders and rocks
#define FLAG_TEMP_B      (TEMP_FLAGS_START + 0xB)  // Formerly unused flag. Can be used for HM objects like trees, boulders and rocks
#define FLAG_TEMP_C      (TEMP_FLAGS_START + 0xC)  // Formerly unused flag. Can be used for HM objects like trees, boulders and rocks
#define FLAG_TEMP_D      (TEMP_FLAGS_START + 0xD)  // Formerly unused flag. Can be used for HM objects like trees, boulders and rocks
#define FLAG_TEMP_E      (TEMP_FLAGS_START + 0xE)  // Formerly unused flag. Can be used for HM objects like trees, boulders and rocks
#define FLAG_TEMP_F      (TEMP_FLAGS_START + 0xF)  // Formerly unused flag. Can be used for HM objects like trees, boulders and rocks
#define FLAG_TEMP_10     (TEMP_FLAGS_START + 0x10) // Formerly unused flag. Can be used for HM objects like trees, boulders and rocks
...
#define FLAG_HIDDEN_ITEM_PETALBURG_WOODS_REVIVE						(FLAG_HIDDEN_ITEMS_START + 0x70)
#define FLAG_HIDDEN_ITEM_PETALBURG_WOODS_GREAT_BALL_1				(FLAG_HIDDEN_ITEMS_START + 0x71)
#define FLAG_HIDDEN_ITEM_PETALBURG_WOODS_PROTEIN_1					(FLAG_HIDDEN_ITEMS_START + 0x72)
#define FLAG_HIDDEN_ITEM_PETALBURG_WOODS_CARBOS						(FLAG_HIDDEN_ITEMS_START + 0x73)
#define FLAG_HIDDEN_ITEM_PETALBURG_WOODS_PROTEIN_2					(FLAG_HIDDEN_ITEMS_START + 0x74)
#define FLAG_HIDDEN_ITEM_PETALBURG_WOODS_SUPER_REPEL_1				(FLAG_HIDDEN_ITEMS_START + 0x75)
#define FLAG_HIDDEN_ITEM_PETALBURG_WOODS_SUPER_REPEL_2				(FLAG_HIDDEN_ITEMS_START + 0x76)
...
#define FLAG_ITEM_DEV_ROOM_HM                                       0x493 // Gives all HMs
#define FLAG_ITEM_DEV_ROOM_MASTER_BALL                              0x494 // Also gives 3 HM slaves, the Secret Power TM and all gym badges
#define FLAG_ITEM_DEV_ROOM_DECORATIONS                              0x495 // Gives 16 secret base decorations
#define FLAG_UNUSED_0x496                                           0x496 // Unused Flag
#define FLAG_UNUSED_0x497                                           0x497 // Unused Flag
#define FLAG_UNUSED_0x498                                           0x498 // Unused Flag
#define FLAG_ITEM_PETALBURG_WOODS_ARENA_PASSAGE_RARE_CANDY          0x499
#define FLAG_ITEM_PETALBURG_WOODS_GREAT_BALL_2                      0x49A
#define FLAG_ITEM_PETALBURG_WOODS_SUPER_POTION                      0x49B
#define FLAG_ITEM_PETALBURG_WOODS_RARE_CANDY                        0x49C
#define FLAG_ITEM_PETALBURG_WOODS_FULL_HEAL                         0x49D
#define FLAG_ITEM_PETALBURG_WOODS_ARENA_COLOSSAL_NUGGET             0x49E
