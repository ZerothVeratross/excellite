...
const struct Tileset gTileset_NewRusturfTunnel =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_NewRusturfTunnel,
    .palettes = gTilesetPalettes_NewRusturfTunnel,
    .metatiles = gMetatiles_NewRusturfTunnel,
