...
static const u8 sDoorAnimTiles_SailorResort[] = INCBIN_U8("graphics/door_anims/resort.4bpp");
...
static const u8 sDoorAnimPalettes_SailorResort[] = {12, 12, 12, 12, 12, 12, 12, 12};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
	...
	{METATILE_Dewford_Resort_Door,                          DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_SailorResort, sDoorAnimPalettes_SailorResort},
    {},
};
